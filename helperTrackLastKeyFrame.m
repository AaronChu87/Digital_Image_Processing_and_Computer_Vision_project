...
[index3d, index2d]    = findWorldPointsInView(mapPoints, lastKeyFrameId); % find the points index of last keyframe in the 3d world map
...
% Refine camera pose with motion only BA
...
xyzPoints = mapPoints.WorldPoints(index3d,:); % all points in previous key frame
